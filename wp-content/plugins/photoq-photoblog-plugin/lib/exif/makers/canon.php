...
function lookup_Canon_tag($tag) {
	...
	switch($tag) {
		...
		case "0095": $tag = "LensModel"; break; //Manuel: this is interesting info as well	
	...
	if($type=="ASCII") {
		...
		if($tag=="0001") { //first chunk
			...
			switch($result['AFPointSelected']) {
				case 8197: $result['AFPointSelected'] = "Manual AF point selection"; break; //Manuel: added this one
				case 12288: $result['AFPointSelected'] = "Manuel Focus"; break;
				case 12289: $result['AFPointSelected'] = "Auto AF point selection"; break;
				...
				case 16385: $result['AFPointSelected'] = "Auto AF point selection"; break; //Manuel: added this one
				case 16390: $result['AFPointSelected'] = "Face Detect"; break; //Manuel: added this one
			...
			switch($result['ExposureMode']) {
				...
				case 6: $result['ExposureMode'] = "M-Dep"; break; //Manuel: added this one
				case 7: $result['ExposureMode'] = "Bulb"; break; //Manuel: added this one
